...
python rsa_main.py $naive_still_in_path $model_path $time_window $naive_still_sv_path $eeg_distance $model_distance $experiment_type $stimuli_type --avg_subjects_rdm > naive_still_MF_out.txt
...
experiment_type="naive"
python rsa_main.py $naive_still_in_path $model_path $time_window $naive_still_sv_path $eeg_distance $model_distance $experiment_type $stimuli_type --avg_subjects_rdm > naive_still_FF_out_sep_subj.txt
...
stimuli_type="video"
experiment_type="naive"
python rsa_main.py $naive_video_in_path $model_path $time_window $naive_video_sv_path $eeg_distance $model_distance $experiment_type $stimuli_type --avg_subjects_rdm > naive_video_out_sep_subj.txt
...
python rsa_main.py $prior_still_in_path $model_path $time_window $prior_still_sv_path $eeg_distance $model_distance $experiment_type $stimuli_type --avg_subjects_rdm > prior_still_out_sep_subj.txt
...
stimuli_type="video"
experiment_type="prior"
python rsa_main.py $prior_video_in_path $model_path $time_window $prior_video_sv_path $eeg_distance $model_distance $experiment_type $stimuli_type --avg_subjects_rdm > prior_video_out_sep_subj.txt
